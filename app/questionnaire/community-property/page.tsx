...
import { CommunityPropertyForm } from "./Form";

const SLUG = "community-property";

export default async function CommunityPropertyPage({
  searchParams,
}: {
  ...
  const { gates, kase } = await loadCaseBundle(caseId);
